...
p = plt.plot(up3,yp3, 'b-', label="Numerical @t' = 0.2")
p = plt.plot(up3exact,yp3, 'bo', label="Analytic @t' = 0.2")
p = plt.plot(up4,yp4, 'y-', label="Numerical @t' = 1.598")
p = plt.plot(up4exact,yp4, 'yo', label="Analytic @t' = 1.598")
plt.setp(p, linewidth='1.0')
plt.axis([MinX,MaxX, MinY, MaxY])
plt.xscale('linear')
plt.yscale('linear')
